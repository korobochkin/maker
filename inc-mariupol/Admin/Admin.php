...
class Admin {
	...
	public static function run() {
		...
		add_action( 'init', array( 'Korobochkin\MakerMariupol\Admin\MetaBoxes\Loader', 'init' ) );
		add_action( 'add_meta_boxes', array( 'Korobochkin\MakerMariupol\Admin\MetaBoxes\Loader', 'add' ) );
